...
describe 'mysql_service::single on centos-5.8' do
  ...
  context 'stepping into mysql_service[default] resource' do
    it 'installs package[default :create mysql-server]' do
      expect(mysql_service_single_55_centos_5_8_stepinto).to install_package('default :create mysql-server')
    ...
    it 'deletes file[default :create /etc/mysql/my.cnf]' do
      expect(mysql_service_single_55_centos_5_8_stepinto).to delete_file('default :create /etc/mysql/my.cnf')
        .with(:path => '/etc/mysql/my.cnf')
    end

    it 'deletes file[default :create /etc/my.cnf]' do
      expect(mysql_service_single_55_centos_5_8_stepinto).to delete_file('default :create /etc/my.cnf')
        .with(:path => '/etc/my.cnf')
    end

    it 'creates directory[default :create /etc/mysql-default]' do
      expect(mysql_service_single_55_centos_5_8_stepinto).to create_directory('default :create /etc/mysql-default')
        .with(
    ...
    it 'creates directory[default :create /etc/mysql-default/conf.d]' do
      expect(mysql_service_single_55_centos_5_8_stepinto).to create_directory('default :create /etc/mysql-default/conf.d')
        .with(
    ...
    it 'creates directory[default :create /var/run/mysql-default]' do
      expect(mysql_service_single_55_centos_5_8_stepinto).to create_directory('default :create /var/run/mysql-default')
        .with(
    ...
    it 'creates directory[default :create /var/log/mysql-default]' do
      expect(mysql_service_single_55_centos_5_8_stepinto).to create_directory('default :create /var/log/mysql-default')
        .with(
    ...
    it 'creates template[default :create /etc/mysql-default/my.cnf]' do
      expect(mysql_service_single_55_centos_5_8_stepinto).to create_template('default :create /etc/mysql-default/my.cnf')
        .with(
