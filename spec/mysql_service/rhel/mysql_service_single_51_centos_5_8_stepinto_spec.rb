...
describe 'mysql_service::single on centos-5.8' do
  let(:mysql_service_single_51_centos_5_8_stepinto) do
    ChefSpec::Runner.new(
      :platform => 'centos',
      :version => '5.8',
  ...
  context 'compiling the test recipe' do
    it 'creates mysql_service[default]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to create_mysql_service('default')
    end
  end
  ...
  context 'stepping into mysql_service[default] resource' do
    it 'installs package[default :create mysql51-mysql-server]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to install_package('default :create mysql51-mysql-server')
        .with(:package_name => 'mysql51-mysql-server', :version => nil)
    end

    it 'creates group[default :create mysql]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to create_group('default :create mysql')
        .with(:group_name => 'mysql')
    end

    it 'creates user[default :create mysql]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to create_user('default :create mysql')
        .with(:username => 'mysql')
    end

    it 'deletes file[default :create /opt/rh/mysql51/root/etc/mysql/my.cnf]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to delete_file('default :create /opt/rh/mysql51/root/etc/mysql/my.cnf')
        .with(:path => '/opt/rh/mysql51/root/etc/mysql/my.cnf')
    end

    it 'deletes file[default :create /opt/rh/mysql51/root/etc/my.cnf]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to delete_file('default :create /opt/rh/mysql51/root/etc/my.cnf')
        .with(:path => '/opt/rh/mysql51/root/etc/my.cnf')
    end

    it 'creates directory[default :create /opt/rh/mysql51/root/etc/mysql-default]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to create_directory('default :create /opt/rh/mysql51/root/etc/mysql-default')
        .with(
    ...
    it 'creates directory[default :create /opt/rh/mysql51/root/etc/mysql-default/conf.d]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to create_directory('default :create /opt/rh/mysql51/root/etc/mysql-default/conf.d')
        .with(
    ...
    it 'creates directory[default :create /opt/rh/mysql51/root/var/run/mysql-default]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to create_directory('default :create /opt/rh/mysql51/root/var/run/mysql-default')
        .with(
    ...
    it 'creates directory[default :create /opt/rh/mysql51/root/var/log/mysql-default]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to create_directory('default :create /opt/rh/mysql51/root/var/log/mysql-default')
        .with(
    ...
    it 'creates directory[default :create /var/lib/mysql-default]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to create_directory('default :create /var/lib/mysql-default')
        .with(
    ...
    it 'creates template[default :create /opt/rh/mysql51/root/etc/mysql-default/my.cnf]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to create_template('default :create /opt/rh/mysql51/root/etc/mysql-default/my.cnf')
        .with(
    ...
    it 'runs bash[default :create initialize mysql database]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to_not run_bash('default :create initialize mysql database')
        .with(
    ...
    it 'runs bash[default :create initial records]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to_not run_bash('default :create initial records')
    end

    it 'creates template[default :start /etc/init.d/mysql-default]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to create_template('default :start /etc/init.d/mysql-default')
        .with(
    ...
    it 'starts service[default :start mysql-default]' do
      expect(mysql_service_single_51_centos_5_8_stepinto).to start_service('default :start mysql-default')
        .with(
