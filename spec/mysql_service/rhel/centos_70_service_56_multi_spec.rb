...
describe 'mysql_service::single on centos-7.0' do
  let(:centos_70_service_56_multi) do
    ChefSpec::Runner.new(
      :platform => 'centos',
      :version => '7.0',
  ...
  context 'stepping into mysql_service[instance-1] resource' do
    ...
    it 'create template[instance-1 :start /etc/init.d/mysql-instance-1]' do
      expect(centos_70_service_56_multi).to create_template('instance-1 :start /etc/init.d/mysql-instance-1')
        .with(
  ...
  context 'stepping into mysql_service[instance-2] resource' do
    ...
    it 'create template[instance-2 :start /etc/init.d/mysql-instance-2]' do
      expect(centos_70_service_56_multi).to create_template('instance-2 :start /etc/init.d/mysql-instance-2')
        .with(
